---
title: "Mağaza"
description: "Artemis Studio ürün ve eklenti lisanslarını satın alın."
---

## Satın Alma Süreci

1. Ürünü seçin ve lisans tipini belirleyin.
2. Satın alma talebinizi e-posta ile iletin: `mailto:info@artemisstudio.com`.
3. Ödeme onayı sonrası lisans anahtarınız e-posta ile ulaştırılır.

<Note>
  Otomatik mağaza entegrasyonu yakında. Geçici süreyle manuel faturalandırma uygulanır.
</Note>
